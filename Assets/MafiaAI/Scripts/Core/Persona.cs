    ...
    public static class PersonaLibrary
    {
        public static readonly Persona[] All =
        {
            new Persona("카이", "다혈질·직설",
                ...
                "빙빙 돌리지 말고 '너 방금 말 바꿨잖아'처럼 바로 찌른다. 예의 바른 존댓말, 걱정스럽다는 식의 순한 표현은 거의 쓰지 않는다.",
                0.95f),
